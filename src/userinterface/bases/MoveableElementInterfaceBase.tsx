...
import {
  MaxMoveableDistanceOutsideBorder,
  StandardHeight,
...
export function MoveableElementInterfaceBase<T extends IMoveableElement>(
  props: IMoveableElementInterfaceBaseProps<T>
) {
  var dataContext = useContext(DataContext);

  const maxXValue =
    dataContext!.stageWidth * dataContext!.sizeScaleFactor +
    MaxMoveableDistanceOutsideBorder;
  ...
  return (
    <Box display="grid" gridTemplateAreas="'positionX positionY'">
